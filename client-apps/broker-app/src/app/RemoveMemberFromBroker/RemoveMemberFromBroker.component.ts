...
@Component({
  selector: 'app-removememberfrombroker',
  templateUrl: './RemoveMemberFromBroker.component.html',
  styleUrls: ['./RemoveMemberFromBroker.component.css'],
  providers: [RemoveMemberFromBrokerService]
})
export class RemoveMemberFromBrokerComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceRemoveMemberFromBroker.getAll()
    .toPromise()
    .then((result) => {
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceRemoveMemberFromBroker.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
