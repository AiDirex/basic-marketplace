...
@Component({
  selector: 'app-sellcointomember',
  templateUrl: './SellCoinToMember.component.html',
  styleUrls: ['./SellCoinToMember.component.css'],
  providers: [SellCoinToMemberService]
})
export class SellCoinToMemberComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceSellCoinToMember.getAll()
    .toPromise()
    .then((result) => {
